;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="9e0185330f3f0a6a4a7b6760c2db1c1e";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["PcCI4vE2u8Ks"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["PcCI4vE2u8Ks"].options={"anonymizeIp":false,"id":"UA-53164437-3","social":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['PcCI4vE2u8Ks'].URLPatterns)){(function(){var options=CloudflareApps.installs['PcCI4vE2u8Ks'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("PcCI4vE2u8Ks"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
